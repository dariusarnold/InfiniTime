...
- Refuse to calibrate shake wake sensitivity while in sleep mode, since the shake detector is disabled during sleep and calibration would silently fail
- Add AOD mode without display dimming for stationary connected devices
